...
- **Parado** : Marque esta caixa se desejar que os itens inativos sejam exibidos nesta página.
...
- A **nome** equipamento.
- **Parado** (pequena cruz) : Significa que o equipamento está inativo (se não estiver lá, o equipamento está ativo).
