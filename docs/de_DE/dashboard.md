...
- Ein Klick auf die Informationen _Zeit_ eines Aktionsbefehls zeigt den Verlauf des Befehls an (falls er historisiert ist).

## Bearbeitungsmodus

Im Bearbeitungsmodus (_der Bleistift oben rechts_), Sie können die Größe der Kacheln und ihre Anordnung im Dashboard ändern.
