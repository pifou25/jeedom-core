...
La página Línea de tiempo le permite mostrar eventos cronológicamente, como cambios de orden _información_, disparadores de comando _Valores_, y ejecuciones de escenarios.
...
- **Guion** : Ya sea directamente en una página de escenario o en _Visión general_ escenarios.
...
La linea de tiempo _Importante_ siempre contiene todos los eventos. Sin embargo, puede filtrar la línea de tiempo por _carpetas_. En cada lugar donde active la línea de tiempo, tendrá un campo para ingresar el nombre de una carpeta, existente o no.
Luego puede filtrar la línea de tiempo por esta carpeta seleccionándola a la izquierda del botón _Actualizar_.
