...
- Plugins that are not in version _steady_ we have an orange dot in front of their name.
...
Click on a plugin, then choose _Install stable_ Where _Install beta_ (if your Market account allows it).

If your Market account is correctly configured on your Jeedom (Configuration → Updates / Market → Market tab), you can click on _Synchronize Market_ or wait for it to settle down on its own.
...
- **Facility** : Allows to install or reinstall dependencies (if you do not do it manually and they are NOK, Jeedom will take care of itself after a while).
