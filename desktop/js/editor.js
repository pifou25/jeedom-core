  ...
  jeeFrontEnd.editor = {
    ...
    setCommandCreatewidget: function (options) {
      document
        ...
        ?.setAttribute("data-page", "widgets");
              ...
              confirm: {
                ...
                callback: {
                  click: function (event) {
                    if (
                      document.getElementById("sel_widgetSubtype").value == ""
                    ) {
                    ...
                    var name =
                      "cmd." +
                      document.getElementById("sel_widgetType").value +
                      "." +
                      document.getElementById("sel_widgetSubtype").value +
                      "." +
                      document.getElementById("in_widgetName").value +
                      ".html";
                    var filePath =
                      "data/customTemplates/" +
                      document.getElementById("sel_widgetVersion").value +
                      "/";
                    jeedom.createFile({
                      path: filePath,
                      name: name,
                      ...
                      success: function () {
                        ...
                        var hash = jeeP.getHashFromPath(
                          filePath
                            .replace("data/customTemplates/", "")
                            .replace("/", ""),
                        );
                        ...
                        var path =
                          filePath.replace("data/customTemplates/", "") + name;
      ...
      editors: [
        {
          ...
          save: function (textarea, editor) {
            ...
            jeeP.killTooltips();
            setTimeout(() => {
              textarea.parentNode.closest(
                "div.ui-dialog.elfinder-dialog-edit",
              ).style.zIndex = 1001;
            }, 150);
            //this.myCodeMirror = null
          },
...
document.getElementById("elfinder").style.height =
  window.innerHeight -
  document.getElementById("jeedomMenuBar").offsetHeight +
  "px";
document
  .querySelectorAll(".ui-state-default.elfinder-navbar.ui-resizable")
  .forEach((el) => {
    el.style.height = "100%";
  });
