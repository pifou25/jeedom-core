...
jeedom.config.load = function (_params) {
  ...
  paramsAJAX.data = {
    action: "getKey",
    key:
      Array.isArray(_params.configuration) ||
      isPlainObject(_params.configuration)
        ? JSON.stringify(_params.configuration)
      ...
      confirm: {
        ...
        callback: {
          click: function (event) {
            ...
            document
              .getElementById("mod_insertGenericType")
              ._jeeDialog.destroy();
          },
        },
      },
