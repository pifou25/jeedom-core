...
class cmd
{
	...
	/**
	 * static function to get value from the command object or array
	 *
	 * @param cmd|array $_input
	 * @param bool $_quote
	...
	/**
	 * select distinct type from every commands in db
	 *
	 * @return array
	 */
	...
	/**
	 * select distinct subType from every commands in db
	 *
	 * @param string $_type optional: type to filter
	 * @return array
	 */
	...
	/**
	 * select distinct unite from every commands in db
	 *
	 * @return array
	 */
	...
	/**
	 * convert color into hexadecimal color
	 *
	 * @param string $_color
	 * @return string
	 */
	...
	/**
	 * list of available widgets into core template dir + plugins template dir
	 *
	 * @param string $_version (dashboard|mobile)
	 * @return array[] multi dimensional array[type][subType][name]
	 */
	...
	/**
	 * check alerts from commands, execute every single alert command action
	 *
	 * @param string[] $_options
	 * @return void
	 */
	...
	/**
	 * format the command value according to its configuration
	 *
	 * @param string[] $_value
	 * @param bool $_quote
	...
	/**
	 * get the 'lastCmdValue' into configuration options
	 *
	 * @return string
	 */
	 ...
	 * dont remove command
	 * 
	 * @return bool always return false; override if needed
	 */
	...
	/**
	 * get the db table name for commands: 'cmd'
	 *
	 * @return string this is a constant = 'cmd'
	 */
	...
	/**
	 * save the command configuration into db
	 *
	 * @see DB::save()
	 * @param bool $_direct
	 * @return void
	...
	/**
	 * refresh db configuration for the command
	 *
	 * @see DB::refresh()
	 * @return void
	 */
	 ...
	 * @return bool = false; this method must be overriden by child class
	 */
	...
	/**
	 * function to execute before and after the command execute method
	 *
	 * @param array $_values
	 * @param string $_type = (jeedomPreExecCmd|jeedomPostExecCmd)
	 * @return void
	 */
	...
	/**
	 * call pre_postExecCmd for the jeedomPreExecCmd
	 *
	 * @param array $_values
	 * @return void
	 */
	...
	/**
	 * call pre_postExecCmd for the jeedomPostExecCmd
	 *
	 * @param array $_values
	 * @return void
	 */
	...
	/**
	 * get widgets selection options
	 * 
	 * Used by modals eqLogic.dashboard.edit and cmd.configure
	 * @see eqLogic::dashboard()
	 * @see cmd::configure()
	 *
	 * @param string $_version
	 * @param bool $_availWidgets
	...
	/**
	 * get generic types selection options
	 *
	 * @return string HTML select options
	 */
	...
	/**
	 * get widget help template HTML
	 *
	 * @param string $_version (dashboard|mobile)
	 * @param string $_widgetName
	 * @return string HTML widget help or description
	 */
	...
	public function getWidgetTemplateCode($_version = 'dashboard', $_clean = true, $_widgetName = '')
	{
		...
		$template_name = 'cmd.' . $this->getType() . '.' . $this->getSubType() . '.' . $widget_name;
		if (
			isset($widget_template[$this->getType()])
			&& isset($widget_template[$this->getType()][$this->getSubType()]) && isset($widget_template[$this->getType()][$this->getSubType()][$widget_name])
		) {
	...
	/**
	 * automatic conversion of the value 
	 *
	 * @param float $_value
	 * @param int $_decimal
	 * @param string $_unit
	...
	/**
	 * function for HTML rendering of the command
	 *
	 * @param string $_version
	 * @param string $_options
	 ...
	 * Undocumented function
	 *
	 * @uses timeline timeline
	 * @param [type] $_value
	 * @param [type] $_datetime
	 * @param int $_loop
	 * @return void
	 */
