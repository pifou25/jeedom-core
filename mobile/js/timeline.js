...
function initTimeline() {
  ...
  jeedom.timeline.listFolder({
    ...
    success: function (data) {
      ...
      rightPanel +=
        '<li><a id="bt_refreshTimeline" href="#"><i class="fas fa-sync"></i> {{Rafraîchir}}</a></li>';
      rightPanel +=
        '<li><a class="changeTimelineFolder active" href="#" data-value="main">{{Principal}}</a></li>';
      rightPanel +=
        '<span class="ui-bottom-sheet-link ui-bottom-sheet-sep">&#160&#160&#160 {{Timelines}} <i class="fas fa-sort-down"></i></span>';
      for (var i in data) {
        if (data[i] == "main") continue;
        rightPanel +=
          '<li><a class="changeTimelineFolder" href="#" data-value="' +
          data[i] +
          '">' +
          data[i] +
          "</a></li>";
      ...
      $("#bottompanel a.changeTimelineFolder")
        .off("click")
        .on("click", function () {
      ...
      window.onscroll = function (event) {
        ...
        if (
          window.scrollY >=
          document.getElementById("timelineContainer").scrollHeight -
            window.innerHeight
        ) {
...
function displayTimelineSegment(_start, _offset) {
  ...
  jeedom.timeline.byFolder({
    folder: document
      .querySelector("#bottompanel .changeTimelineFolder.active")
