...
function initMessage() {
  ...
  rightPanel +=
    '<li><a id="bt_clearMessage" href="#"><i class="far fa-trash-alt"></i> {{Vider}}</a></li>';
  rightPanel += "</ul>";
  ...
  jeedom.message.all({
    ...
    success: function (messages) {
      ...
      for (var i in messages) {
        ...
        tbody +=
          '<td class="msgBin"><i class="far fa-trash-alt cursor removeMessage"></i></td>';
        ...
        tbody +=
          ...
          (messages[i].occurrences === null ? "1" : messages[i].occurrences) +
          "</td>";
        tbody += "</tr>";
      }
